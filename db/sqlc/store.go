...
// TransferTxParams contains the input params
...
// It creates a transfer record, add account entries and updates account's balance within a single database transaction
